...
const InputPage = ({
  ...
  const [parameters, setParameters] = useState({
    ...
    catalystPreferences: ['bodyBreathWork']
  });
          ...
          <div className="parameters-section">
            ...
            <div className="input-grid">
              <div className="input-row">
                ...
                <div className="input-group">
                  <label htmlFor="gatheringSize">Gathering Size</label>
                  <input
                    id="gatheringSize"
                    type="text"
                ...
                <div className="input-group">
                  ...
                  <input
                    id="availableTime"
                    type="text"
                    value={parameters.availableTime + ' minutes'}
              ...
              <div className="input-row">
                <div className="input-group">
                  <label htmlFor="diversity">Diversity of the Group</label>
                  <input
                    id="diversity"
                    type="text"
                ...
                <div className="input-group">
                  <label htmlFor="experience">Experience With<br/>Generative Dialogue</label>
                  <input
                    id="experience"
                    type="text"
              ...
              <div className="input-row">
                <div className="input-group input-group-wide">
                  <label htmlFor="theme">Theme/ Issue<br/>Being Explored</label>
                  <input
                    id="theme"
                    type="text"
                ...
                <div className="input-group input-group-wide">
                  <label htmlFor="context">Context/Field</label>
                  <input
                    id="context"
                    type="text"
